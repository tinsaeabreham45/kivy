...
class MainWidget(RelativeLayout):
    ...
    def reset_game(self):
        ...
        self.source_txt = "SOURCE: " + str(self.current_y_loop)
    ...
    def generate_tile_coordinate(self):
        ...
        if len(self.tile_coordinate) > 0 :
            last_coordinate = self.tile_coordinate[-1]
            last_x = last_coordinate[0] 
            last_y = last_coordinate[1] + 1 
            
        print("foo1")
        
        for i in range(len(self.tile_coordinate), self.NB_TILES):
    ...
    def get_line_x_from_index(self, index):
        ...
        spacing = self.vertical_line_sapcing * self.width
        offset = index - 0.5
        line_x = central_line_x + offset*spacing + self.current_offset_x 
        return line_x
   
    def get_line_y_from_index(self, index): 
        spacing_y = self.horizontal_line_sapcing*self.height
    ...
    def update_tiles(self):
        for i in range(0, self.NB_TILES):
            tile = self.tiles[i]
            tile_coordinates = self.tile_coordinate[i]
    ...
    def update(self, dt):
        ...
        if not self.state_game_over and self.sate_game_has_started:
    ...
    def on_menu_button_pressed(self):
        ...
        self.reset_game()
        self.sate_game_has_started = True
